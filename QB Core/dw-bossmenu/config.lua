...
Config.ApplicationQuestions = {
    ["police"] = {
        {
            question = "Pourquoi souhaitez-vous intégrer le département de police ?",
            type = "text",
            required = true,
            min = 1,
            max = 1024
        ...
        {
            question = "Avez-vous une expérience antérieure dans les forces de l'ordre ?",
            type = "select",
            options = {"Oui", "Non"},
            required = true
        },
        ...
        {
            question = "Comment réagiriez-vous face à une situation de stress intense ?",
            type = "text",
            required = true,
            min = 1,
            max = 1024
